...
| 1.1.0  | <ul><li>Added some sort of bot character (Currently does not pathfind)</li><li>Added "quality" slider to settings (disabled currently)</li><li>Moved drawing from server TPS to client (60 or 30 FPS) and added FPS option</li><li><a href="https://github.com/definitely-nobody-is-here/BattleBoxes_Multiplayer/issues/56" target="_blank">Fixed transparent scoreboard after playing a game</a></li><li>Centered winner name text</li><li>Randomized spawnpoints on Platforms and Battlefield</li><li><a href="https://github.com/definitely-nobody-is-here/BattleBoxes_Multiplayer/issues/58" target="_blank">Fixed force leave on win screen</a></li><li><a href="https://github.com/definitely-nobody-is-here/BattleBoxes_Multiplayer/issues/63" target="_blank">Fixed typo in achievements</a></li><li>Improved camera movement</li><li>Minor optimizations</li></ul> |
